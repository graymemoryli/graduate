...
<div id = "main" align="center">
    <form action="/company/doregist" method="post" enctype="multipart/form-data">
        企业账号：<input type="text" name="account"><br><br>
        企业姓名:<input type="text" name="name"><br><br>
        企业密码：<input type="text" name="password"><br><br>
